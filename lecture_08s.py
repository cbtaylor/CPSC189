...
def plot_posn(t_arr, loargs):
    ...
    """
    for a, d in loargs:
        pyplot.plot(t_arr, position_arr(t_arr, a, d), linestyle='-', linewidth=1)
        pyplot.show()
#===============================================================================

# Exercise 6:
#     
#>>> t_arr = np.arange(0.0, 1.0, 0.01)
#>>> loargs = [(100, 0.1), (95, 0.12)]
#>>> plot_posn(t_arr, loargs)

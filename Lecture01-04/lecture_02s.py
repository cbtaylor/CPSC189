...
def max_nelon(nelon):
    ...
    Produces the maximum of the elements of nelon
...
def sum_pos(loi):
    ...
    produces the sue of the positive ints in loi
    ...
    if loi == []:
        ...
        if loi[0] > 0:
            return loi[0] + sum_pos(loi[1:])
        else:
            return sum_pos(loi[1:])
...
def sum_positive(loi0):
    ...
    def sum_positive_acc(loi, acc):
        ...
        Invariant: acc is the sum of the positive ints seen so far
...
#     """
#     
#     def reverse_acc(los, acc):
#         """
#         Accumulator: acc is ___________
#         
#         Invariant:
#         
#         Examples:
#         reverse_acc(['abc', 'def', 'ghi'], __________)
#         reverse_acc(__________, _________)
#         reverse_acc(__________, _________)        
#         reverse_acc(__________, _________)
#         """
#         if los == []:
#             return ...acc
#         else:
#             return reverse_acc(los[1:], ...los[0] ...acc)
# 
#     return reverse_acc(los0, ...)
#==============================================================================
